 ...
 *
 */
@Autonomous(name = "Auto: Qualifier 12/13 (Blue A6 Start)", group = "A")
public class QualifierAutonomousBlueA6 extends LinearOpMode {
    ...
    public static final Pose2d SHOOT_POSE_2 = SHOOT_POSE;
